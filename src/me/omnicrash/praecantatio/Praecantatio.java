...
public class Praecantatio extends JavaPlugin
{
    ...
    private final PraecantatioPlayerListener playerListener = new PraecantatioPlayerListener(this);
    private final PraecantatioBlockListener blockListener = new PraecantatioBlockListener(this);
    private final PraecantatioEntityListener entityListener = new PraecantatioEntityListener(this);
    ...
    */
    ...
    private void parseConfigs()
    {
    	...
    	try
    	{
			...
			e.printStackTrace();
			log.info("[Praecantatio] Error occured while creating config file: " + e.getMessage());
		}
    	...
    	try
    	{
			...
			e.printStackTrace();
			log.info("[Praecantatio] Error occured while creating spell file: " + e.getMessage());
		}
    	...
    	try
    	{
			...
			e.printStackTrace();
			log.info("[Praecantatio] Error occured while creating users file: " + e.getMessage());
		}
